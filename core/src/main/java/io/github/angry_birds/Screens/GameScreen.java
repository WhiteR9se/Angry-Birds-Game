...
public class GameScreen implements Screen {
    ...
    private ArrayList<Float> timeDelay = new ArrayList<>();
        ...
        Gdx.input.setInputProcessor(new InputAdapter() {
            ...
            public boolean touchDown(int screenX, int screenY, int pointer, int button) {
                ...
                if (gameSetting.getBoundingRectangle().contains(xc, yc)) {
                    game.setScreen(new GameSettingScreen(game, GameScreen.class));
                }
...
//        world.step(1/20f, 1000, 5);
    ...
    public ArrayList<Float> timeDelay(){
        return timeDelay;
    }
    @Override
    public void pause() {}
